...
namespace KF_WebAPI.DataLogic
{
    public class AE_Approval_Loan_Sales
    {
        public async Task<IEnumerable<CommissionReportRow>> GetReportDataAsync(ReportQueryParameters parameters)
        {
            ...
            var (sql_txt, sql_txt_CS, dynamicParams) = BuildWhereClause(parameters, user);
            ...
            try
            {
                ...
                var dtResult = await connection.QueryAsync<CommissionReportRow>(finalSql, dynamicParams);
        ...
        private (string SqlTxt, string SqlTxtCs, DynamicParameters Parameters) BuildWhereClause(
            ...
            UserContext user)
        {
            ...
            if (!string.IsNullOrEmpty(planNum))
            {
                ...
                dynamicParams.Add("PlanNum", planNum);
            }
            else if (!string.IsNullOrEmpty(uBcTitle))
            {
                ...
                else
                {
                    ...
                    dynamicParams.Add("UbcTitle", uBcTitle);
                }
            }
            ...
            if (!string.IsNullOrEmpty(parameters.CS_introducer))
            {
                ...
                dynamicParams.Add("CSIntroducer", $"%{parameters.CS_introducer}%");
            }
        ...
        ");
            dynamicParams.Add("SelYearS", parameters.SelYear_S);
