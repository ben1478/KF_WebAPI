            ...
            ");
                ...
                if (dtResult.Rows.Count > 0)
                {
                    var PerformanceList = dtResult.AsEnumerable().Select(row => new Performance_res
                    {
                        ...
                        Jan_C = row.IsNull("Jan_C") ? "0" : row.Field<string>("Jan_C"),
                        Feb_C = row.IsNull("Feb_C") ? "0" : row.Field<string>("Feb_C"),
                        Mar_C = row.IsNull("Mar_C") ? "0" : row.Field<string>("Mar_C"),
                        Apr_C = row.IsNull("Apr_C") ? "0" : row.Field<string>("Apr_C"),
                        May_C = row.IsNull("May_C") ? "0" : row.Field<string>("May_C"),
                        Jun_C = row.IsNull("Jun_C") ? "0" : row.Field<string>("Jun_C"),
                        Jul_C = row.IsNull("Jul_C") ? "0" : row.Field<string>("Jul_C"),
                        Aug_C = row.IsNull("Aug_C") ? "0" : row.Field<string>("Aug_C"),
                        Sep_C = row.IsNull("Sep_C") ? "0" : row.Field<string>("Sep_C"),
                        Oct_C = row.IsNull("Oct_C") ? "0" : row.Field<string>("Oct_C"),
                        Nov_C = row.IsNull("Nov_C") ? "0" : row.Field<string>("Nov_C"),
                        Dec_C = row.IsNull("Dec_C") ? "0" : row.Field<string>("Dec_C"),
