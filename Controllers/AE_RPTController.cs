...
namespace KF_WebAPI.Controllers
{
    ...
    public class AE_RPTController : Controller
    {
        ...
        /// </summary>
        [HttpGet("GetShowMoreType")]
        public ActionResult<ResultClass<string>> GetShowMoreType()
        {
        ...
        public ActionResult<ResultClass<string>> GetTeamUsers()
        {
            ...
            try
            {
                ...
                T_SQL = T_SQL + " AND isnull(U_type,'')='' AND (U_leave_date is null OR U_leave_date >= GETDATE())";
        ...
        /// <summary>
        /// 提供可查詢業務人員之權限(當show_more_type='N'時呼叫 然後在呼叫Feat_user_list) Get_UG_list/Feat_user_list.asp&_fn.asp
        /// </summary>
        [HttpGet("Get_UG_list")]
